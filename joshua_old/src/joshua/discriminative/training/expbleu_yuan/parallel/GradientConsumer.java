package joshua.discriminative.training.expbleu_yuan.parallel;
...
import joshua.discriminative.training.expbleu_yuan.ExpbleuGradientComputer;
import joshua.discriminative.training.expbleu_yuan.ExpbleuSemiringParser;
...
//	private static int id = 0;
	...
	public GradientConsumer(BlockingQueue<HGAndReferences> q, List<FeatureTemplate> featTemplates, HashMap<String, Integer> featureStringToIntegerMap, double[] theta, SymbolTable symbolTbl, ExpbleuGradientComputer expbleuGradientComputer) {
		super(q);
		...
		this.computer = expbleuGradientComputer;
//		++id;
