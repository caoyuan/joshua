...
package joshua.zmert.meteor.src.edu.cmu.meteor.scorer;

import java.util.ArrayList;

import joshua.zmert.meteor.src.edu.cmu.meteor.aligner.Aligner;
import joshua.zmert.meteor.src.edu.cmu.meteor.aligner.Alignment;
import joshua.zmert.meteor.src.edu.cmu.meteor.util.Constants;
import joshua.zmert.meteor.src.edu.cmu.meteor.util.Normalizer;
