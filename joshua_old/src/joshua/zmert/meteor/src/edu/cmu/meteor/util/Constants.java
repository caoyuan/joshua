...
package joshua.zmert.meteor.src.edu.cmu.meteor.util;
...
import joshua.zmert.meteor.src.org.tartarus.snowball.SnowballStemmer;
import joshua.zmert.meteor.src.org.tartarus.snowball.ext.englishStemmer;
import joshua.zmert.meteor.src.org.tartarus.snowball.ext.frenchStemmer;
import joshua.zmert.meteor.src.org.tartarus.snowball.ext.germanStemmer;
import joshua.zmert.meteor.src.org.tartarus.snowball.ext.spanishStemmer;

import joshua.zmert.meteor.src.edu.cmu.meteor.aligner.PartialAlignment;
...
public class Constants {
	...
	public static URL getDefaultParaFileURL(int langID) {
		...
		String fileName = "/joshua/zmert/meteor/data/paraphrase-" + shortLang + ".gz";
		try {
