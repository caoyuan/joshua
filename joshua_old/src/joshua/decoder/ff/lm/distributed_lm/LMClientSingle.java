 ...
 * @version $LastChangedDate: 2009-12-29 14:58:42 -0500 (Tue, 29 Dec 2009) $
 */
public class LMClientSingle extends LMClient {
	...
	public double get_prob(int[] ngram, int order) {
		...
		return Double.parseDouble(cmd_res);
	}
	...
	public int[] get_right_euqi_state(int[] original_state, int order) {
		throw new RuntimeException("Error: call get_right_euqi_state in lmclient, must exit");
