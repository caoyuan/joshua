...
//===============================================================
	...
	throws IOException {
		...
		//{
		//	System.out.print(this.featureFunctions.get(0).getWeight() + " " );
		//}
		//System.out.println();
		...
		if (oracleSentence != null) {
			...
			for( int i=0; i<11; i++ )
			{
				System.out.println("featID: "+ this.featureFunctions.get(i).getFeatureID());
				System.out.println("featWt: "+ this.featureFunctions.get(i).getWeight());
			}*/
			
			//EXTRACT THE K-BEST LIST
			this.kbestExtractor.lazyKBestExtractOnHG(
