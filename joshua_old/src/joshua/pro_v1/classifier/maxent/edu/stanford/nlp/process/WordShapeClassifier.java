...
public class WordShapeClassifier {
  ...
  /**
   * Usage: <code>java joshua.pro.classifier.maxent.edu.stanford.nlp.process.WordShapeClassifier
  ...
  public static void main(String[] args) {
    ...
    if (args.length == 0) {
      System.out.println("joshua.pro.classifier.maxent.edu.stanford.nlp.process.WordShapeClassifier [-wordShape name] string+");
