...
import joshua.pro.classifier.maxent.edu.stanford.nlp.util.IntPair;
...
public class CoreAnnotations {
   ...
   * tree. See {@link joshua.pro.classifier.maxent.edu.stanford.nlp.trees.Tree#indexSpans(int)}. This annotation counts tokens.
   ...
   * tree.  See {@link joshua.pro.classifier.maxent.edu.stanford.nlp.trees.Tree#indexSpans(int)}. This annotation counts
   ...
   * {@link joshua.pro.classifier.maxent.edu.stanford.nlp.process.WordShapeClassifier} for functions for
