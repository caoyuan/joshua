package joshua.pro.classifier.maxent.edu.stanford.nlp.sequences;

import joshua.pro.classifier.maxent.edu.stanford.nlp.ling.CoreLabel;
import joshua.pro.classifier.maxent.edu.stanford.nlp.optimization.StochasticCalculateMethods;
 ...
 *  {@link joshua.pro.classifier.maxent.edu.stanford.nlp.ie.NERFeatureFactory}.
 *  Documentation for the flags for Chinese word segmentation can be
 *  found in the Javadoc of
 *  {@link joshua.pro.classifier.maxent.edu.stanford.nlp.wordseg.ChineseSegmenterFeatureFactory}.
 *  <p/>
 *
...
public class SeqClassifierFlags implements Serializable {
  ...
  // feature factory
  public String featureFactory = "joshua.pro.classifier.maxent.edu.stanford.nlp.ie.NERFeatureFactory";
  ...
  public String readerAndWriter = "joshua.pro.classifier.maxent.edu.stanford.nlp.sequences.ColumnDocumentReaderAndWriter";
  ...
  public String tokenFactory = "joshua.pro.classifier.maxent.edu.stanford.nlp.process.CoreLabelTokenFactory";
  public String tokensAnnotationClassName = "joshua.pro.classifier.maxent.edu.stanford.nlp.ling.CoreAnnotations$TokensAnnotation";
    ...
    for (Enumeration e = props.propertyNames(); e.hasMoreElements(); ) {
      ...
      if (key.equalsIgnoreCase("macro")) {
        if (Boolean.parseBoolean(val)) {
          ...
          readerAndWriter = "joshua.pro.classifier.maxent.edu.stanford.nlp.sequences.CoNLLDocumentReaderAndWriter";
        ...
        if (Boolean.parseBoolean(val)) {
          // featureFactory = "joshua.pro.classifier.maxent.edu.stanford.nlp.ie.NERFeatureFactory";
          readerAndWriter = "joshua.pro.classifier.maxent.edu.stanford.nlp.sequences.CoNLLDocumentReaderAndWriter";
          useObservedSequencesOnly = true;
          // useClassFeature = true;
          useLongSequences = true;
        ...
        if (Boolean.parseBoolean(val)) {
          readerAndWriter = "joshua.pro.classifier.maxent.edu.stanford.nlp.sequences.ColumnDocumentReaderAndWriter";
        ...
        if (featureFactory.equalsIgnoreCase("SuperSimpleFeatureFactory")) {
          featureFactory = "joshua.pro.classifier.maxent.edu.stanford.nlp.sequences.SuperSimpleFeatureFactory";
        } else if (featureFactory.equalsIgnoreCase("NERFeatureFactory")) {
          featureFactory = "joshua.pro.classifier.maxent.edu.stanford.nlp.ie.NERFeatureFactory";
        } else if (featureFactory.equalsIgnoreCase("GazNERFeatureFactory")) {
          featureFactory = "joshua.pro.classifier.maxent.edu.stanford.nlp.sequences.GazNERFeatureFactory";
        } else if (featureFactory.equalsIgnoreCase("IncludeAllFeatureFactory")) {
          featureFactory = "joshua.pro.classifier.maxent.edu.stanford.nlp.sequences.IncludeAllFeatureFactory";
        }
