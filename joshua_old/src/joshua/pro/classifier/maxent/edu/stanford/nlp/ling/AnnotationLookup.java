...
import joshua.pro.classifier.maxent.edu.stanford.nlp.ling.CoreAnnotations.AfterAnnotation;
import joshua.pro.classifier.maxent.edu.stanford.nlp.ling.CoreAnnotations.AnswerAnnotation;
import joshua.pro.classifier.maxent.edu.stanford.nlp.ling.CoreAnnotations.ArgumentAnnotation;
import joshua.pro.classifier.maxent.edu.stanford.nlp.ling.CoreAnnotations.BeforeAnnotation;
import joshua.pro.classifier.maxent.edu.stanford.nlp.ling.CoreAnnotations.CharacterOffsetBeginAnnotation;
import joshua.pro.classifier.maxent.edu.stanford.nlp.ling.CoreAnnotations.CategoryAnnotation;
import joshua.pro.classifier.maxent.edu.stanford.nlp.ling.CoreAnnotations.CategoryFunctionalTagAnnotation;
import joshua.pro.classifier.maxent.edu.stanford.nlp.ling.CoreAnnotations.ChineseCharAnnotation;
import joshua.pro.classifier.maxent.edu.stanford.nlp.ling.CoreAnnotations.ChineseOrigSegAnnotation;
import joshua.pro.classifier.maxent.edu.stanford.nlp.ling.CoreAnnotations.ChineseSegAnnotation;
import joshua.pro.classifier.maxent.edu.stanford.nlp.ling.CoreAnnotations.ChunkAnnotation;
import joshua.pro.classifier.maxent.edu.stanford.nlp.ling.CoreAnnotations.OriginalTextAnnotation;
import joshua.pro.classifier.maxent.edu.stanford.nlp.ling.CoreAnnotations.DocIDAnnotation;
import joshua.pro.classifier.maxent.edu.stanford.nlp.ling.CoreAnnotations.CharacterOffsetEndAnnotation;
import joshua.pro.classifier.maxent.edu.stanford.nlp.ling.CoreAnnotations.FeaturesAnnotation;
import joshua.pro.classifier.maxent.edu.stanford.nlp.ling.CoreAnnotations.GazetteerAnnotation;
import joshua.pro.classifier.maxent.edu.stanford.nlp.ling.CoreAnnotations.GoldAnswerAnnotation;
import joshua.pro.classifier.maxent.edu.stanford.nlp.ling.CoreAnnotations.IDFAnnotation;
import joshua.pro.classifier.maxent.edu.stanford.nlp.ling.CoreAnnotations.IndexAnnotation;
import joshua.pro.classifier.maxent.edu.stanford.nlp.ling.CoreAnnotations.InterpretationAnnotation;
import joshua.pro.classifier.maxent.edu.stanford.nlp.ling.CoreAnnotations.LeftTermAnnotation;
import joshua.pro.classifier.maxent.edu.stanford.nlp.ling.CoreAnnotations.LemmaAnnotation;
import joshua.pro.classifier.maxent.edu.stanford.nlp.ling.CoreAnnotations.MarkingAnnotation;
import joshua.pro.classifier.maxent.edu.stanford.nlp.ling.CoreAnnotations.MorphoCaseAnnotation;
import joshua.pro.classifier.maxent.edu.stanford.nlp.ling.CoreAnnotations.MorphoGenAnnotation;
import joshua.pro.classifier.maxent.edu.stanford.nlp.ling.CoreAnnotations.MorphoNumAnnotation;
import joshua.pro.classifier.maxent.edu.stanford.nlp.ling.CoreAnnotations.MorphoPersAnnotation;
import joshua.pro.classifier.maxent.edu.stanford.nlp.ling.CoreAnnotations.NamedEntityTagAnnotation;
import joshua.pro.classifier.maxent.edu.stanford.nlp.ling.CoreAnnotations.NormalizedNamedEntityTagAnnotation;
import joshua.pro.classifier.maxent.edu.stanford.nlp.ling.CoreAnnotations.ParentAnnotation;
import joshua.pro.classifier.maxent.edu.stanford.nlp.ling.CoreAnnotations.PolarityAnnotation;
import joshua.pro.classifier.maxent.edu.stanford.nlp.ling.CoreAnnotations.ProjectedCategoryAnnotation;
import joshua.pro.classifier.maxent.edu.stanford.nlp.ling.CoreAnnotations.ProtoAnnotation;
import joshua.pro.classifier.maxent.edu.stanford.nlp.ling.CoreAnnotations.RoleAnnotation;
import joshua.pro.classifier.maxent.edu.stanford.nlp.ling.CoreAnnotations.SemanticHeadTagAnnotation;
import joshua.pro.classifier.maxent.edu.stanford.nlp.ling.CoreAnnotations.SemanticHeadWordAnnotation;
import joshua.pro.classifier.maxent.edu.stanford.nlp.ling.CoreAnnotations.SentenceIndexAnnotation;
import joshua.pro.classifier.maxent.edu.stanford.nlp.ling.CoreAnnotations.ShapeAnnotation;
import joshua.pro.classifier.maxent.edu.stanford.nlp.ling.CoreAnnotations.SpanAnnotation;
import joshua.pro.classifier.maxent.edu.stanford.nlp.ling.CoreAnnotations.StemAnnotation;
import joshua.pro.classifier.maxent.edu.stanford.nlp.ling.CoreAnnotations.PartOfSpeechAnnotation;
import joshua.pro.classifier.maxent.edu.stanford.nlp.ling.CoreAnnotations.TextAnnotation;
import joshua.pro.classifier.maxent.edu.stanford.nlp.ling.CoreAnnotations.ValueAnnotation;
import joshua.pro.classifier.maxent.edu.stanford.nlp.ling.CoreAnnotations.VerbSenseAnnotation;
import joshua.pro.classifier.maxent.edu.stanford.nlp.ling.CoreAnnotations.WordnetSynAnnotation;
import joshua.pro.classifier.maxent.edu.stanford.nlp.ling.CoreLabel.GenericAnnotation;
...
public class AnnotationLookup {
  ...
  public enum KeyLookup {
    ...
    HEAD_WORD_KEY("joshua.pro.classifier.maxent.edu.stanford.nlp.ling.TreeCoreAnnotations.HeadWordAnnotation", OldFeatureLabelKeys.HEAD_WORD_KEY),
    HEAD_TAG_KEY("joshua.pro.classifier.maxent.edu.stanford.nlp.ling.TreeCoreAnnotations.HeadTagAnnotation", OldFeatureLabelKeys.HEAD_TAG_KEY),
