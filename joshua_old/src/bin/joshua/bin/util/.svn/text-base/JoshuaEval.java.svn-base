...
*/
			...
			System.err.println("FileNotFoundException in JoshuaEval.initialize(int): " + e.getMessage());
			System.exit(99901);
		} catch (IOException e) {
			System.err.println("IOException in JoshuaEval.initialize(int): " + e.getMessage());
			System.exit(99902);
		}
  ...
  private static void processDocInfo()
  {
    ...
    if (docInfoFileName == null) {
      ...
      try {
        ...
        System.err.println("FileNotFoundException in JoshuaEval.processDocInfo(): " + e.getMessage());
        System.exit(99901);
      } catch (IOException e) {
        System.err.println("IOException in JoshuaEval.processDocInfo(): " + e.getMessage());
        System.exit(99902);
      }
    }
	...
	private static String createUnifiedRefFile(String prefix, int numFiles) {
		if (numFiles < 2) {
			...
			try {
				...
				System.err.println("FileNotFoundException in JoshuaEval.createUnifiedRefFile(String,int): " + e.getMessage());
				System.exit(99901);
			} catch (IOException e) {
				System.err.println("IOException in JoshuaEval.createUnifiedRefFile(String,int): " + e.getMessage());
				System.exit(99902);
			}
...
//		println("split_on: " + split_on);
	...
	private static int countLines(String fileName) {
		...
		try {
			...
			System.err.println("IOException in JoshuaEval.countLines(String): " + e.getMessage());
			System.exit(99902);
		}
	...
	private static int countNonEmptyLines(String fileName)
	{
		...
		try {
			...
			System.err.println("IOException in JoshuaEval.countNonEmptyLines(String): " + e.getMessage());
			System.exit(99902);
		}
