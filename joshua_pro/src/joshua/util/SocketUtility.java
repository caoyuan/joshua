 ...
 * @version $LastChangedDate: 2009-05-15 23:22:32 -0400 (Fri, 15 May 2009) $
 */
public class SocketUtility {
	...
	open_connection_client(String hostname, int port) {
		...
		try {
			...
			//file
			res.in = new BufferedReader(
				new InputStreamReader(res.socket.getInputStream()));
			res.out = new PrintWriter(
				new OutputStreamWriter(res.socket.getOutputStream()));
