 ...
 * @version $LastChangedDate: 2010-02-08 14:03:13 -0500 (Mon, 08 Feb 2010) $
 */
...
public class HGNode implements Prunable<HGNode> {
	...
	//1. SPAN (i,j)
	//2. HYPEREDGES LEADING TO THE NODE
	//3. STATE ASSOCIATED WITH THE NODE (EG. LM-STATE)
	//4. LHS, NAMELY THE TAG FOR THIS NODE(EG. VP)
...
//===============================================================
	...
	//ADD A LIST OF HYPEREDGES TO THE NODE
	...
	//RETURN STATE ASSOCIATED WITH THE NODE
	...
	//THAT IS, THIS FUNCTION IS NOT SUPPOSED TO BE CALLED HERE. ONCE CALLED, EXIT
