...
*/
        ...
        for (int i = 0; i < numSentences; ++i)
        {
          ...
          //PROCESS CANDIDATE OF THIS ITERATION
          for (int n = 0; n <= sizeOfNBest; ++n) 
          {
          // Why up to and *including* sizeOfNBest?
          // So that it would read the "||||||" separator even if there is
...
//              println("",4);
              ...
              //{
            //	  System.out.print(featVal_str[p]+" ");
              //}
              //System.out.println();
              
              //System.out.println(featVal_array.length);//+" "+featVal_array[0][i].length);
              //for( int p=0; p<numParams; p++ )
              //{
            	//  System.out.print(featVal_array[p][i][featVal_array[p][i].length-1]+" ");
              //}
              //System.out.println();
...
//        cleanupMemory();
      ...
      //ALL THE JOBS ABOVE IS TO PROCESS THE PREVIOUS AND NEW N-BEST LIST, COMPUTE ITS SUFF STATS AND OUTPUT ALL INFO TO temp.sent, temp.stat, temp.feat
      ...
      for (int j = 1; j <= initsPerIt; ++j) {
        ...
        //initialLambda: INITIAL j^th WEIGHT VEC
