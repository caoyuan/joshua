		...
		if (MRConfig.useSparseFeature) {
			...
			if (MRConfig.useMicroTMFeat) {
				...
				this.microRuleFeatureTemplate = new MicroRuleFT(
						...
						MRConfig.endTargetNgramOrder, MRConfig.wordMapFile, symbolTbl);
...
//		try to abbrevate the featuers if possible
	...
	//SAVE NEW PARAMS TO FILES "configOutput(eg: joshua.config.2)" and "sparseFeaturesOutput(eg: micro.rule.feat.sup.500.2)"
