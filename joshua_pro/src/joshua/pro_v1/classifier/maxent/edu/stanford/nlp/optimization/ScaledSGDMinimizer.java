...
public class ScaledSGDMinimizer extends StochasticMinimizer {
  ...
  public double tuneFixedGain(joshua.pro.classifier.maxent.edu.stanford.nlp.optimization.Function function, double[] initial, long msPerTest,double fixedStart){
  ...
  @Override
  public Pair<Integer,Double> tune( joshua.pro.classifier.maxent.edu.stanford.nlp.optimization.Function function,double[] initial, long msPerTest){
