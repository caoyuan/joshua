...
//             }
  ...
  */
  ...
  /**
   * Provides a consistent ordering over arrays. First compares by the first
   * element. If that element is equal, the next element is considered, and so
   * on. This is the array version of {@link CollectionUtils.compareLists} and
   * uses the same logic when the arrays are of different lengths.
   */
