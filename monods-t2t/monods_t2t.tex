...
Recently, \newcite{Chan2011} investigated combining phrasal
...
Figure~\ref{fig-pattern-scoring} shows a pairwise comparison breakdown
...
\caption{A breakdown of the of the collected human judgments comparing
  the systems head to head.}\label{fig-pattern-scoring}
\end{figure}
