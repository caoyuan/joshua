...
public class PROCore {
  ...
  // USED FOR PRO
  private String classifierAlg; // THE CLASSIFICATION ALGORITHM(PERCEP, MEGAM,
                                // MAXENT ...)
  private String trainingMode;
  private String nbestFormat; // NBEST FILE FORMAT: dense or sparse
  private String[] classifierParams = null; // THE PARAM ARRAY FOR EACH
                                            // CLASSIFIER
  private int Tau;
  private int Xi;
  ...
  public double[] run_single_iteration(int iteration, int minIts, int maxIts, int prevIts,
    ...
    while (!done) { // NOTE: this "loop" will only be carried out once
      ...
      finalLambda[1] = opt.run_Optimizer(); // FOR MODE 3, THE REGULAR WEIGHTS
                                            // ARE NOT UPDATED
