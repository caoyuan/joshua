package joshua.pro.classifier.maxent.edu.stanford.nlp.math;
...
public final class SloppyMath {
  ...
  public static void main(String[] args) {
    if (args.length == 0) {
      System.err.println("Usage: java joshua.pro.classifier.maxent.edu.stanford.nlp.math.SloppyMath " + "[-logAdd|-fishers k n r m|-binomial r n p");
