...
import joshua.pro.classifier.maxent.edu.stanford.nlp.util.Filter;
import joshua.pro.classifier.maxent.edu.stanford.nlp.util.MapFactory;
import joshua.pro.classifier.maxent.edu.stanford.nlp.util.MutableInteger;
...
public class IntCounter<E> extends AbstractCounter<E> implements Serializable {
   ...
   * really you should create a {@link joshua.pro.classifier.maxent.edu.stanford.nlp.stats.Distribution} instead of using this method.
   */
