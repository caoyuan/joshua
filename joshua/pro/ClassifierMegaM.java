...
public class ClassifierMegaM implements ClassifierInterface 
{
	...
	@Override
	/* for MegaM classifier:
	 * param[0] = MegaM command file path
	 * param[1] = MegaM training data file(generated on the fly) path
	 * param[2] = MegaM weight file(generated after training) path
	 * note that the training and weight file path should be consistent with that specified in the command file
	 */
